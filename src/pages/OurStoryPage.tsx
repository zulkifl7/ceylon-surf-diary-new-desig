  ...
  return (
    <div className="pt-32 pb-20 px-6">
      <div className="max-w-5xl mx-auto">
        <h1 className={`text-5xl text-center py-20 mb-20 font-jedira tracking-wide transition-all duration-1000 ease-out ${
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <div 
            ref={imageRef}
            className={`aspect-square bg-gray-200 rounded-lg overflow-hidden sticky top-32 transition-all duration-1000 ease-out ${
          ...
          >
            ...
            <div className="space-y-6">
              <p className={`text-gray-700 leading-relaxed font-poppins transition-all duration-1000 ease-out ${
                contentVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'
